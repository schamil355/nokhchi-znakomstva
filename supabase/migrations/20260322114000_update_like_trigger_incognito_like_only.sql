--------------------------------------------------------------------------------
-- Update enqueue_like_push: If liker is incognito, only send like.received and
-- skip match.new pushes. Otherwise keep match behavior (but still avoid
-- duplicate match pushes when match already exists).
--------------------------------------------------------------------------------
...
begin
  ...
  -- If liker is incognito, do not send match push
