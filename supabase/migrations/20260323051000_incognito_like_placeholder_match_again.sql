--------------------------------------------------------------------------------
-- When an incognito user likes someone, create a match placeholder (for list),
-- but still no match.push unless both are visible.
--------------------------------------------------------------------------------
...
begin
  ...
  -- Send like push ONLY wenn Liker inkognito ist, und lege Platzhalter-Match an
  if liker_incognito then
    ...
    -- Platzhalter-Match, damit es im Matches-Tab erscheint (anonym, ohne Foto)
