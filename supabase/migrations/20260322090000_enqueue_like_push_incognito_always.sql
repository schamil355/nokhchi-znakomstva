--------------------------------------------------------------------------------
-- Like push should always notify the recipient, including when the liker is
-- in incognito mode. Keep mutual-like match pushes for both participants.
--------------------------------------------------------------------------------
...
begin
  ...
  -- Always send like push (includes incognito flag so the client can decide)
